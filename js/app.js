(() => {
    ...
    function initSliders() {
        if (document.querySelector(".discount-block__slider")) new core(".discount-block__slider", {
        ...
        if (document.querySelector(".categories-block__slider")) new core(".categories-block__slider", {
            modules: [ Navigation ],
            observer: true,
            watchOverflow: true,
            observeParents: true,
